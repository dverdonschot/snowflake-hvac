  ...
  create or replace   view HVAC_ANALYTICS.dbt_dev.int_service_performance_metrics
...
WITH service_with_feedback AS (
    ...
    FROM HVAC_ANALYTICS.dbt_dev.stg_hvac__service_calls sc
    LEFT JOIN HVAC_ANALYTICS.dbt_dev.stg_hvac__customer_feedback cf 
