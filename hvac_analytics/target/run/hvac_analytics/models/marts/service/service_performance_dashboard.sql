...
create or replace transient table HVAC_ANALYTICS.dbt_dev.service_performance_dashboard
...
WITH technician_performance AS (
    ...
    FROM HVAC_ANALYTICS.dbt_dev.stg_hvac__technicians t
    LEFT JOIN HVAC_ANALYTICS.dbt_dev.int_service_performance_metrics spm 
